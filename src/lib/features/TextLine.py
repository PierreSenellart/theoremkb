...
class TextLineFeaturesExtractor(FeatureExtractor):
    ...
    def get(self, line: ET.Element) -> dict:
        ...
        block        = line.xpath(f"./ancestor::alto:TextBlock", namespaces = ALTO_NS)[0] # TextBlock
        ...
        f = {}
        # geometry
        f["line_position"]  = str(StatusFeature.from_element(line, relative_to=f"alto:TextBlock"))
        #f["position_h"]     = line_h
        #f["position_v"]     = line_v
